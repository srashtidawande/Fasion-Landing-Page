...
const offers = [
    ...
    },
    {
        ...
        image: "https://images.unsplash.com/photo-1594465919760-441fe5908ab0?auto=format&fit=crop&q=75&w=800",
        bg: "bg-[#fffafa]",
        textColor: "text-black",
        badge: "ATELIER",
    ...
    },
    {
        ...
        image: "https://images.unsplash.com/photo-1523381235312-3a1647fa9921?auto=format&fit=crop&q=75&w=800",
        bg: "bg-[#f3e5f5]",
        ...
        <section className="pt-10 pb-24 bg-[var(--bg-primary)] transition-colors duration-500 overflow-hidden">
            <div className="container-custom relative">
                ...
                <div className="flex flex-col md:flex-row items-start md:items-end justify-between mb-16 gap-8">
                    <div>
                        <span className="overline-text">Exclusive Curation</span>
                        <h2 className="heading-luxury-sm">The Seasonal <span className="not-italic font-bold">Offerings</span></h2>
                    </div>
                        ...
                        {offers.map((offer) => (
                            ...
                            >
                                <motion.div
                                    ...
                                    className={`${offer.bg} rounded-[2.5rem] p-8 md:p-10 relative overflow-hidden group min-h-[420px] flex flex-col justify-between border border-black/5 dark:border-[var(--border-color)] shadow-sm hover:shadow-2xl hover:border-accent/20 transition-all duration-500 cursor-pointer active:scale-[0.98]`}
                                >
                                    {/* Content */}
                ...
                <div className="flex justify-center gap-3 mt-12">
                    {Array.from({ length: maxIndex + 1 }).map((_, i) => (
                        <button
                            ...
                            className={`h-2 rounded-full transition-all duration-500 ${i === currentIndex ? 'w-10 bg-accent' : 'w-2 bg-black/10 dark:bg-[var(--border-color)]'}`}
